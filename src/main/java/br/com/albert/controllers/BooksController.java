...
import br.com.albert.services.BooksService;
...
public class BooksController {
	...
	public BooksDTO findById(@PathVariable(value = "id") Integer id) {
		return services.findById(id); //services.findById;
	}
	
	@PostMapping(consumes = {MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML, MediaType.APPLICATION_YML}
				, produces = {MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML, MediaType.APPLICATION_YML})
	@Operation(summary = "Creates a book by id", description = "Creates a book by passing in a JSON, XML or YML representation of the book",
	tags = {"Books"},
	responses = {
			@ApiResponse(description = "Success", responseCode = "200",
